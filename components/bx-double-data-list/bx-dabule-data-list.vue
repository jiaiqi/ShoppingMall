		...
		<view class="list-wrap">
			...
			finishText="我是有底线的...">
				<list-dab-item
					...
					@click-list-item-cont="clickListItemCont"
				></list-dab-item>
			</s-pull-scroll>
		</view>
...
<script>
import listDabItem from '@/components/bx-double-data-list/bx-dabule-data-list-item.vue';
import sPullScroll from '@/components/s-pull-scroll';
export default {
	name:"dab-list",
	components: { listDabItem, sPullScroll },
	data() {
		return {
			listData: [],
			noData: false,
	...
	methods: {
		...
		clickListItemCont(data){
			this.$emit('clickListItemCont',data)
		},
		async getListV2() {
