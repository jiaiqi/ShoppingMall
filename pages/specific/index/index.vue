...
<view class="">
	...
	<view class="cu-bar tabbar bg-white shadow foot">
		...
		<view class="action"  v-if="!isShopmgt" @click="NavChange" data-cur="shoppingCart">
			<view class='cuIcon-cu-image'>
		...
		<view class="action" v-if="!isShopmgt" @click="NavChange" data-cur="mine">
			<view class='cuIcon-cu-image'>
...
<script>
	...
	export default {
		...
		created(e) {
			...
			let roles = this.userRoles.join('-')
			if(roles.indexOf("shop_operator") !== -1 || roles.indexOf("shop_manage") !== -1){
				this.isShopmgt = true
			}else{
