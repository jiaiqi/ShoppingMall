	...
	methods: {
		...
		saveWxUser() {
			...
			if (isWeixinClient) {
              ...
              let user_no = that.$store.getters.getLoginUserInfo?that.$store.getters.getLoginUserInfo.login_user_info:''
              console.log('getLoginUserInfo-user_no',user_no)
              console.log(this.$store.getters.getUpUser)
              let e = {
                user_no:user_no,
                up_user_no:this.$store.getters.getUpUser
              }
              that.addToVipList(e)
            }
						uni.hideToast()
