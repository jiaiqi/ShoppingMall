...
export default {
  ...
  setShopInfo:({commit},payload)=>{
	  commit('setShopInfo', payload)
  },
  setVipInfo:({commit},payload)=>{
  	  commit('setVipInfo', payload)
  },
  setLoginUserInfo:({commit},payload)=>{
    commit('setLoginUserInfo', payload)
  },
  setVisitorInfo:({commit},payload)=>{
    commit('setVisitorInfo', payload)
  },
